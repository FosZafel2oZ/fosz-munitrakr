...
├─ tests/                          node tests/run.js — 164 unit tests
│  ├─ run.js                       runner
...
- **Tests:** `node tests/run.js` → must print `164/164 passed, 0 failed`.
